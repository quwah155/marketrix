...
export default async function VerifyEmailPage(props: Props) {
  ...
  return (
    <div className="animate-fade-in text-center">
      {result.success ? (
        <>
          <div className="flex h-16 w-16 items-center justify-center rounded-full bg-emerald-950 mx-auto mb-5">
        ...
        <>
          <div className="flex h-16 w-16 items-center justify-center rounded-full bg-red-950 mx-auto mb-5">
